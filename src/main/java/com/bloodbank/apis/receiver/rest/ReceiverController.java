...
public class ReceiverController {
  ...
  public ResponseEntity<Receiver> getReceiverById(@PathVariable Long receiverId) {
  ...
  public ResponseEntity<Receiver> updateReceiver(@PathVariable Long receiverid,
      @RequestBody Receiver updatedReceiver) {
  ...
  public ResponseEntity<String> deleteReceiver(@PathVariable Long receiverId) {
